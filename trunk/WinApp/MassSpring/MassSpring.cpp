// MassSpring.cpp : Defines the entry point for the application.
//
                     ...
                     int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_MASSSPRING, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, (LPCTSTR)IDC_MASSSPRING);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, (LPCTSTR)IDC_MASSSPRING);
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= (LPCTSTR)IDC_MASSSPRING;
...
void BuildScene()
{
	...
	MassSpringSystem::MassSpringSystemPtr pMS(new MassSpringSystem);
	...
	pMS->AddSpring(pS0);
	pMS->AddSpring(pS1);
	pMS->AddConnect(pP0, pP1, pS0);
	pMS->AddConnect(pP1, pP0, pS0);
	pMS->AddConnect(pP1, pP2, pS1);
	pMS->AddConnect(pP2, pP1, pS1);
	MassSpringNode::MassSpringNodePtr pMSNode(new MassSpringNode);
	pMSNode->Setup(pMS);

	pMat->AddChild(pMSNode);
