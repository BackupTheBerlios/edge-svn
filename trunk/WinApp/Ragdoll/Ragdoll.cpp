// Ragdoll.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "Ragdoll.h"
#include "../../Render/Render.hpp"
#include "../../Render/BoneNode.hpp"
                     ...
                     int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_RAGDOLL, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, (LPCTSTR)IDC_RAGDOLL);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, (LPCTSTR)IDC_RAGDOLL);
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= (LPCTSTR)IDC_RAGDOLL;
...
void BuildScene()
{
	...
	TranslatePtr pTranslate(new Translate);
	Scale::ScalePtr pScaleGround(new Scale);
	Edge::BoneNodePtr pBoneNode(new BoneNode);
